...
public class BattleChooseAdapter extends BaseAdapter {
    Context context;
    ArrayList<Team> listOfTeams;

    public BattleChooseAdapter (Context c, ArrayList<Team> ls) {
        context = c;
        listOfTeams = ls;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            LayoutInflater mInflater = (LayoutInflater) context.getSystemService(BattleChooseActivity.LAYOUT_INFLATER_SERVICE);
