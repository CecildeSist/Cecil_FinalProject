...
public class TeamDeleteAdapter extends BaseAdapter {
    Context context;
    ArrayList<Team> listOfTeams;

    public TeamDeleteAdapter (Context c, ArrayList<Team> ls) {
        context = c;
        listOfTeams = ls;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            LayoutInflater mInflater = (LayoutInflater) context.getSystemService(DeleteTeamActivity.LAYOUT_INFLATER_SERVICE);
